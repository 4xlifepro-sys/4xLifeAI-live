...
async function main() {
  const EUR_PAIRS = ['EURUSD', 'EURGBP', 'EURJPY', 'GBPUSD', 'USDJPY', 'USDCHF', 'USDCAD', 'AUDUSD', 'NZDUSD', 'AUDJPY', 'CADJPY', 'CHFJPY', 'NZDJPY', 'GBPJPY', 'EURAUD'];

  console.log('\n===================================================================');
  console.log('RESEARCH: Optimized EUR Strategy V2 - M5 Timeframe');
  console.log('Target: 60%+ WR, 8 pip min SL, 4+ signals/day');
  console.log('===================================================================');
  ...
  console.log(`Target: 4+ signals/day | Current: ${signalsPerDay.toFixed(2)} signals/day`);

  fs.default.writeFileSync('backtest-optimized-eur-v2-results.json', JSON.stringify({ perPair, combined, allTrades }, null, 0));
  console.log('\nSaved to backtest-optimized-eur-v2-results.json');
}
