...
import { Mail, Lock, User, Loader2, Target, AlertCircle, CheckCircle2, ShieldAlert, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (msg === '{}' || msg.includes('AuthRetryableFetchError')) {
         msg = 'Unable to complete signup at this moment. Please try again in a few seconds.';
      }
      setError(msg);
    } finally {
      setLoading(false);
    ...
    <div className="flex-1 flex flex-col items-center justify-center p-6 w-full relative z-10">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-[#8A95A5]">Join 4xLifeAI</p>
        </div>
