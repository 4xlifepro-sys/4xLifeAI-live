    ...
    <div className="flex-1 w-full relative overflow-hidden bg-[#0A0D12]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10 space-y-8">
        ...
        {/* Hero Banner Grid Box format */}
         <div className="relative bg-[#0D101A] border border-[#202735] rounded-2xl p-5 sm:p-8 md:p-12 overflow-hidden shadow-2xl">
            {/* Background Icon */}
            ...
            <div className="relative z-10 w-full max-w-3xl">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-teal-500/10 text-teal-400 rounded-full text-xs font-bold tracking-widest uppercase mb-6">
                 ...
                 <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 tracking-tight">Invite Friends & Earn 10% Cash Commission</h1>
                <p className="text-[#8A95A5] text-lg leading-relaxed mb-1">
                    Help grow the 4xLifeAI premium signal community. When your friends sign up via your unique invitation code and upgrade to Premium, you receive a <span className="text-teal-400 font-semibold">10% cash commission ($2.50)</span> paid directly in USDT.
                </p>
        ...
        <div className="space-y-4 pt-4">
            ...
            <div className="flex flex-col sm:flex-row bg-[#0D101A] border border-[#202735] rounded-xl p-2 sm:items-center shadow-lg gap-2 sm:gap-0">
                ...
                <button 
                    onClick={handleCopy}
                    className="w-full sm:w-auto px-6 py-3.5 bg-teal-500 hover:bg-teal-400 text-[#052E26] rounded-lg font-bold text-sm tracking-widest uppercase transition-colors flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(20,184,166,0.3)]"
                >
            ...
            <div className="bg-[#0D101A] border border-[#202735] rounded-xl overflow-hidden min-h-[200px] shadow-lg">
                ...
                {payouts.length === 0 ? (
                    ...
                    <div className="divide-y divide-[#202735]">
                         <div className="grid grid-cols-3 px-3 sm:px-6 py-3 bg-[#111520] text-[10px] font-bold tracking-widest text-[#5D6B80] uppercase">
                             <div>Request Date</div>
                             <div>Amount Requested</div>
                             <div className="text-right">Node Status</div>
                         </div>
                         {payouts.map(p => (
                             <div key={p.id} className="grid grid-cols-3 px-3 sm:px-6 py-4 items-center text-sm">
